...
SettingsGui.Title := "Settings - " ProgramTitle
...
OpenAbout(*){
    ...
    aboutLink := AboutGui.Add("Link",,'<a href="https://github.com/Stefarling/AHKser">AHKser Source Code</a>')
    autoHotkeyLink := AboutGui.Add("Link",,'<a href="https://www.autohotkey.com/">AutoHotkey</a>')
